...
namespace BookReviewAPI
{
    public class Startup
    {
        ...
        public Startup(IConfiguration configuration)
        {
            ...
            ConnectionString = Configuration.GetConnectionString("DefoultConnectionString");
        }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AppDbContex>(options => options.UseSqlServer(ConnectionString));
            //Configure Services
